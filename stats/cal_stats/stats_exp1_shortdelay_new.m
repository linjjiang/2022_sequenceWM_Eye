...
% data directory
data_dir1 = './eye_data/v3_short_delay/';
...
run_names = str2double(cellfun(@(x) erase(x,[data_dir1,'sMGS']),{file_dirs1(ind).folder},'UniformOutput',false));
    ...
    for jj = 1:length(ind) % for each run
        ...
        if ~isempty(file) % if there is preprocessed data *step6.mat
            ...
            %% 2. Let's calculate and summarize errors
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% final_sind2 = find(tr_exc_quad <= 50 & tr_exc_ord <= 50);
% 
...
% 
% % save the qa
% save(fullfile(output,'qa_exp1_shortdelay.mat'),'qa','final_sind2')
